...
| **OE-DOC-002** | [OE-DOC-002-system-architecture.md](./OE-DOC-002-system-architecture.md) | End-to-end system: browser, web, ML API, Postgres, optional local LLM |
...
| **OE-DOC-006** | [OE-DOC-006-configuration-and-environment.md](./OE-DOC-006-configuration-and-environment.md) | Environment variables, Compose vs host-only dev |
...
| Location | Role |
|----------|------|
| [../README.md](../README.md) | Clone, Linux + Compose stack, local Next.js quick start |
